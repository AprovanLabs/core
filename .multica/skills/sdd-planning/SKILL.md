---
name: sdd-planning
description: Guides the Architect through authoring a Software Design Document (SDD). Use this skill at the start of any design or architecture task before writing code or opening a PR.
triggers:
  - design
  - architecture
  - SDD
...
Use this skill when you need to author a Software Design Document before implementation begins.

## When to Use

Trigger this skill when:
- You are assigned an issue tagged as a design or architecture task
- An issue description says "design first" or "write SDD"
...
4. Identify **stakeholders**: which agents or humans will review this SDD?
...
1. Check `docs/` for any existing architecture docs, ADRs, or relevant SDD files.
...
## Phase 3 — Draft the SDD

Create the file at `docs/sdd/<slug>.md` (slug = lowercase, hyphens, max 40 chars).
...
1. Commit the SDD to a branch: `git checkout -b docs/sdd/<slug>`.
2. Open a PR with title `docs: add SDD for <topic>`.
...
- Address review comments directly in the SDD file.
